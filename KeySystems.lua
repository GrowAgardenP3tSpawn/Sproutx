...
local Window = Rayfield:CreateWindow({
    ...
    LoadingTitle = "Verificación",

    LoadingSubtitle = "by technoourielcompany", -- Tu nombre aquí
...
local KeyBox = Tab:CreateInput({
    ...
    PlaceholderText = "Escribe tu clave aquí...",
    ...
    Callback = function(text)
        ...
        if string.lower(text) == "miclave123" then
            ...
            Rayfield:Notify({
                ...
                Content = "Clave verificada con éxito",
...
local GetKeyButton = Tab:CreateButton({
    ...
    Callback = function()
        ...
        local link = "https://roblox.com.ge/communities/9554073285//" -- Cambia a tu link real
        ...
        Rayfield:Notify({
            ...
            Content = "Se copió el link de la Key al portapapeles",
